...
Set-AzContext -SubscriptionName 'Training'
```
...
```powershell
# Create new Microsoft Entra group using Microsoft Graph PowerShell
# Install module if needed: Install-Module Microsoft.Graph -Scope CurrentUser
Connect-MgGraph -Scopes "Group.ReadWrite.All"
New-MgGroup -DisplayName "AZ104-Administrators" -MailNickname "AZ104Admins" -Description "Azure Administrators Group" -MailEnabled:$false -SecurityEnabled:$true
```

```azurecli
# Create new Microsoft Entra group using CLI
az ad group create --display-name "AZ104-Administrators" --mail-nickname "AZ104Admins" --description "Azure Administrators Group"
```

#### Update Microsoft Entra Group
```powershell
# Update Microsoft Entra group properties using Microsoft Graph PowerShell
$group = Get-MgGroup -Filter "DisplayName eq 'AZ104-Administrators'"
Update-MgGroup -GroupId $group.Id -DisplayName "AZ104-Updated-Administrators"
```

```azurecli
# Update Microsoft Entra group using CLI
